...
#   c) node1 mines 32 blocks, so now node 0 has 60001sno, node 1 has 4250sno, node2 has none.
#   d) node0 sends 601 sno to node2, in two transactions (301 sno, then 300 sno).
