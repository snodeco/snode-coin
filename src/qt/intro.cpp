...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Snodecoin Core"),
     ...
     * override -datadir in the snodecoin.conf file in the default data directory
     * (to be consistent with snodecoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
