                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Snodecoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Snodecoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and snodecoin: URIs)"));
...
*/
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Snodecoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Snodecoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Snodecoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Snodecoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Snodecoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a Snodecoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Snodecoin Core help message to get a list with possible Snodecoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Snodecoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Snodecoin network", "", count));
}
...
{
    QString strTitle = tr("Snodecoin Core"); // default title
