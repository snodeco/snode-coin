...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/snodecoin-cli.cpp \
           src/snodecoin-tx.cpp \
           src/snodecoin.cpp \
           src/db.cpp \
           ...
           src/qt/snodecoin.cpp \
           src/qt/snodecoinstrings.cpp \
...
RESOURCES += src/qt/snodecoin.qrc src/qt/snodecoin_locale.qrc

TRANSLATIONS += src/qt/locale/snodecoin_bg.ts \
                src/qt/locale/snodecoin_de.ts \
                src/qt/locale/snodecoin_en.ts \
                src/qt/locale/snodecoin_es.ts \
                src/qt/locale/snodecoin_fi.ts \
                src/qt/locale/snodecoin_fr.ts \
                src/qt/locale/snodecoin_it.ts \
                src/qt/locale/snodecoin_ja.ts \
                src/qt/locale/snodecoin_pl.ts \
                src/qt/locale/snodecoin_pt.ts \
                src/qt/locale/snodecoin_ru.ts \
                src/qt/locale/snodecoin_sk.ts \
                src/qt/locale/snodecoin_sv.ts \
                src/qt/locale/snodecoin_vi.ts \
                src/qt/locale/snodecoin_zh_CN.ts \
                src/qt/locale/snodecoin_zh_TW.ts
