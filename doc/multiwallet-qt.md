...
In order to support loading of multiple wallets in snodecoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is snodecoin.cpp.
...
Changes to snodecoin.cpp
----------------------
snodecoin.cpp is the entry point into snodecoin-qt, and as such, will require some minor modifications to provide hooks for
