...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 SND at the same time
...
enum ZerocoinSpendStatus {
    ZSND_SPEND_OKAY = 0,                            // No error
    ZSND_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZSND_WALLET_LOCKED = 2,                         // Wallet was locked
    ZSND_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZSND_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZSND_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZSND_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZSND_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZSND_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZSND_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZSND_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZSND_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZSND_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZSND_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZSND_SPENT_USED_ZSND = 14,                      // Coin has already been spend
    ZSND_TX_TOO_LARGE = 15                          // The transaction is larger than the max tx size
};
...
public:
    ...
    */
    ...
    /** zSND reset */
    boost::signals2::signal<void()> NotifyzSNDReset;
};
