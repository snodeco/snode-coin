...
/* Snodecoin GUI -- Size of icons in status bar */
...
#define COLOR_UNCONFIRMED QColor(60, 174, 240) // Snode blue
/* Transaction list -- negative amount */
#define COLOR_NEGATIVE QColor(186, 33, 33) // Snode red
...
#define QAPP_ORG_NAME "Snodecoin"
#define QAPP_ORG_DOMAIN "snode.co"
#define QAPP_APP_NAME_DEFAULT "Snodecoin-Qt"
#define QAPP_APP_NAME_TESTNET "Snodecoin-Qt-testnet"
