...
/** Utility functions used by the Snodecoin Qt UI.
 */
namespace GUIUtil
{
...
// Render Snodecoin addresses in monospace font
...
// Parse "snodecoin:" URI into recipient object, return true on successful parsing
