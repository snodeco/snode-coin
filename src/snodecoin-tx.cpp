...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Snodecoin Core snodecoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  snodecoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded snodecoin transaction") + "\n" +
                               "  snodecoin-tx [options] -create [commands]   " + _("Create hex-encoded snodecoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded snodecoin transaction
