...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SND:
        return QString("snodecoin");
    case mSND:
        return QString("msnodecoin");
    case uSND:
        return QString::fromUtf8("usnodecoin");
    default:
        return QString("???");
    }
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SND:
            return QString("SND");
        case mSND:
            return QString("Milli-SND (1 / 1" THIN_SP_UTF8 "000)");
        case uSND:
            return QString("Micro-SND (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
